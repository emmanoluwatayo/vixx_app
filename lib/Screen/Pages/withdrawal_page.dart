          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text("Withdrawal", style: setStyleContent(context, ColorConstant.deepPinkColor,25,FontWeight.bold)),
                SizedBox(height: 10,),
                //balance detail page
                GestureDetector(
                  child:  Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text("Withdraw", style: setStyleContent(context,ColorConstant.slightWhiteColor,24,FontWeight.bold)),
                              Text("Withdraw from as low\nas 20USDT", style: setStyleContent(context, ColorConstant.slightWhiteColor, 14, FontWeight.w400),),
                              GestureDetector(
                                child:  Container(
                                  padding: EdgeInsets.all(10.0),
                                  decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(12), color: ColorConstant.deepPinkColor
                                  ),
                                  child: Center(
                                    child: Text(" Withdraw", style:  setStyleContent(context, ColorConstant.slightWhiteColor, 12, FontWeight.bold),),
                                  ),
                                ),
                                onTap: (){
                          ...
                          Image.asset("assets/images/with_icon.png", height: 55,)
                        ],
                      )
                  ),
                ),
