...
class WithdrawTransactionPage extends StatefulWidget{
  @override
  WithdrawTransactionPageState createState() => WithdrawTransactionPageState();
}

class WithdrawTransactionPageState extends State <WithdrawTransactionPage>{

  String totalAmount = "amount", totalDate = "date", remark= "remark";

  Future <List<void>>? futureData;
  String? withdraw, page;
