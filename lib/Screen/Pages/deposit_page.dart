...
class DepositPageState extends State <DepositPage>{
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text("Deposit", style: setStyleContent(context,ColorConstant.deepBlueColor,25,FontWeight.bold)),
                SizedBox(height: 10,),
                //balance detail page
                GestureDetector(
                  child:  Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text("Deposit", style: setStyleContent(context,ColorConstant.slightWhiteColor,24,FontWeight.bold)),
                              Text("Deposit funds as\nlow as 20USDT", style: setStyleContent(context, ColorConstant.slightWhiteColor, 14, FontWeight.w400),),
                              GestureDetector(
                                child:  Container(
                                  padding: EdgeInsets.all(10.0),
                                  decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(12), color: ColorConstant.deepBlueColor
                                  ),
                                  child: Center(
                                    child: Text("Deposit now", style:  setStyleContent(context, ColorConstant.slightWhiteColor, 12, FontWeight.bold),),
                                  ),
                                ),
                                onTap: (){
                          ...
                          Image.asset("assets/images/wallet_icon.png", height: 55,)
                        ],
                      )
                  ),
                ),
  ...
  Future<bool> depositAction() async {
